...
def _int_array_to_list(x,n):
	return list(map(svmc.int_getitem,[x]*n,list(range(n))))

def _double_array_to_list(x,n):
	return list(map(svmc.double_getitem,[x]*n,list(range(n))))
...
class svm_parameter:
	...
	def __init__(self,**kw):
		...
		for attr,val in list(self.default_parameters.items()):
